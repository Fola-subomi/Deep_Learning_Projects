...
Preprocesses the images (reshaping + normalization)

Builds a CNN model

Trains it to classify digits

Evaluates the model on unseen test images

Saves the trained model as a .h5 file

Can later be used to predict any new handwritten digit image

🧠 Why I Chose MNIST

MNIST is the “Hello World” of deep learning.
It’s clean, simple, and perfect for learning CNNs.

It allowed me to understand:

How convolution layers extract features

Why we use activation functions

Why softmax is used in multi-class classification
